...
public abstract class FleaMobileListView_Roo_Gwt extends MobileProxyListView<FleaProxy> {

    protected Set<String> paths = new HashSet<String>();

    public FleaMobileListView_Roo_Gwt(String buttonText, SafeHtmlRenderer<org.ete.fleacircus.client.managed.request.FleaProxy> renderer) {
