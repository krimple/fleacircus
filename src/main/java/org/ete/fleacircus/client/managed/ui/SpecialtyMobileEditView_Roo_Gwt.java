...
public abstract class SpecialtyMobileEditView_Roo_Gwt extends Composite implements View<SpecialtyMobileEditView> {
    ...
    public void setFleasPickerValues(Collection<FleaProxy> values) {
        fleas.setAcceptableValues(values);
    }
}
