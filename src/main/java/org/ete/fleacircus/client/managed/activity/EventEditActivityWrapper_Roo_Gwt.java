...
public abstract class EventEditActivityWrapper_Roo_Gwt implements Activity, IsScaffoldMobileActivity {
    ...
    public interface View_Roo_Gwt<V extends org.ete.fleacircus.client.scaffold.place.ProxyEditView<org.ete.fleacircus.client.managed.request.EventProxy, V>> extends ProxyEditView<EventProxy, V> {
    }
}
