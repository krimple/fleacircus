...
public class FleaDetailsActivity extends FleaDetailsActivity_Roo_Gwt {

    private final PlaceController placeController;

    private final ProxyDetailsView<FleaProxy> view;

    private AcceptsOneWidget display;

    public FleaDetailsActivity(EntityProxyId<org.ete.fleacircus.client.managed.request.FleaProxy> proxyId, ApplicationRequestFactory requests, PlaceController placeController, ProxyDetailsView<org.ete.fleacircus.client.managed.request.FleaProxy> view) {
    ...
    public void deleteClicked() {
        ...
        requests.fleaRequest().remove().using(view.getValue()).fire(new Receiver<Void>() {
    ...
    public Place getBackButtonPlace() {
        return new ProxyListPlace(FleaProxy.class);
    }
